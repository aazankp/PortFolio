                            ...
                            <div class="py-4 text-base leading-6 space-y-2 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="grid grid-cols-6 gap-4">
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="fname" name="fname" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Full Name" />
                                    ...
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="email" name="email" type="email" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Email Address" />
                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="address" name="address" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Address" />
                                    ...
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="zipcode" name="zipcode" type="number" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Zip Code" />
                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="mobile" name="mobile" type="number" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Mobile" />
                                    ...
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="dob" name="dob" type="date" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Password" />
                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="password" name="password" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Password" />
                                            <label for="password" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Password</label>
                                        </div>
                                    </div>
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="confirmpassword" name="confirmpassword" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600" placeholder="Confirm Password" />
