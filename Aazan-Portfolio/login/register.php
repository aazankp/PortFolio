                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-4 text-base leading-6 space-y-2 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    ...
                                    <div class="sm:col-span-12 xl:col-span-3 h-12">
                                        <div class="relative">
                                            <input autocomplete="off" id="confirmpassword" name="confirmpassword" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-teal-400 text-gray-900 focus:outline-none focus:borer-teal-600 text-base" placeholder="Confirm Password" />
